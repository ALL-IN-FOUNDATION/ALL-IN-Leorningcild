...
/* ─ NAV ─ */
nav{position:fixed;top:28px;left:0;right:0;z-index:599;display:flex;align-items:center;justify-content:space-between;padding:.7rem 1.5rem;background:rgba(2,4,10,.95);border-bottom:1px solid rgba(212,168,83,.1);backdrop-filter:blur(20px)}
.nav-logo{font-family:'Libre Baskerville',serif;font-style:italic;font-weight:700;font-size:1.05rem;letter-spacing:.04em;color:var(--gold);display:flex;align-items:center;gap:.45rem;text-decoration:none}
.nav-badge{font-family:'Barlow Condensed',sans-serif;font-style:normal;font-weight:700;font-size:.46rem;letter-spacing:.22em;text-transform:uppercase;padding:.18rem .55rem;border:1px solid rgba(212,168,83,.22);color:var(--gold);background:rgba(212,168,83,.05)}
.ph-btn{display:inline-flex;align-items:center;gap:.45rem;font-family:'Barlow Condensed',sans-serif;font-weight:700;font-size:.7rem;letter-spacing:.15em;text-transform:uppercase;padding:.48rem 1rem;background:transparent;color:var(--cream);border:1px solid rgba(171,159,242,.35);cursor:pointer;transition:all .22s}
...
/* ─ PAGE HEADER ─ */
.page-header{padding:calc(28px + 52px + 24px + 2.2rem) 1.5rem 1.6rem;max-width:1200px;margin:0 auto}
...
.eyebrow-txt{font-size:.5rem;font-weight:700;letter-spacing:.32em;color:var(--teal);text-transform:uppercase}
.page-title{font-family:'Libre Baskerville',serif;font-weight:700;font-style:italic;font-size:clamp(1.9rem,7vw,3.2rem);color:var(--cream);line-height:.9;margin-bottom:.65rem}
.page-title span{color:var(--gold)}
.page-desc{font-size:.68rem;font-weight:300;letter-spacing:.04em;line-height:1.9;color:var(--dim);max-width:540px}
.wallet-notice{margin-top:1.1rem;display:inline-flex;align-items:center;gap:.55rem;padding:.5rem .9rem;border:1px dashed rgba(171,159,242,.22);background:rgba(171,159,242,.04);font-size:.56rem;font-weight:600;letter-spacing:.12em;color:rgba(171,159,242,.6);text-transform:uppercase}
...
<nav>
  ...
  <button class="ph-btn" id="navBtn" onclick="walletClick()">
    <img id="navPhLogo" src="https://phantom.app/favicon.ico"
         onerror="this.src='https://i.ibb.co/N2rPjhM/phantom-icon.png';this.onerror=null" alt="Phantom">
...
<div class="page-header">
  ...
  <div class="wallet-notice" id="walletNotice">
    <img src="https://phantom.app/favicon.ico"
         onerror="this.src='https://i.ibb.co/N2rPjhM/phantom-icon.png';this.onerror=null" alt="Phantom">
...
<div class="app-wrap">
  ...
  <div>
    <div class="wbar">
      <img class="wbar-logo" src="https://phantom.app/favicon.ico"
           onerror="this.src='https://i.ibb.co/N2rPjhM/phantom-icon.png';this.onerror=null" alt="Phantom">
      <div class="wbar-info">
...
<div class="overlay" id="phModal">
  <div class="modal" style="max-width:350px">
    ...
    <div class="mhead">
      <div class="mtitle">
        <img src="https://phantom.app/favicon.ico" onerror="this.src='https://i.ibb.co/N2rPjhM/phantom-icon.png';this.onerror=null" alt="Phantom">
        Connect Phantom
      </div>
...
function openPhModal(){
  ...
  var html;
  var logo = 'https://phantom.app/favicon.ico';
  if(ENV.mob){
