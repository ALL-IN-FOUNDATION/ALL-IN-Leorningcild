...
.page-title{font-family:'Libre Baskerville',serif;font-weight:700;font-style:italic;font-size:clamp(1.4rem,7vw,3.2rem);color:var(--cream);line-height:.9;margin-bottom:.65rem}
...
<nav>
  ...
  <button class="ph-btn" id="navBtn" onclick="walletClick()">
    <img id="navPhLogo" src="/phantom-logo.png" alt="Phantom">
...
<div class="app-wrap">
  ...
  <div>
    <div class="wbar">
      <img class="wbar-logo" src="/phantom-logo.png" alt="Phantom">
      <div class="wbar-info">
...
window.addEventListener('load', function(){
  ...
  // Re-detect Phantom saat user kembali ke tab dari Phantom app (mobile)
