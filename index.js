...
function openPhModal(){
  ...
  if(ENV.mob){
    html = '<img src="'+logo+'" style="width:48px;height:48px;border-radius:12px;margin:0 auto .75rem;display:block" alt="Phantom">' +
      '<div class="mtext"><b>Phantom tidak terdeteksi di browser ini.</b><br>Untuk connect, kamu perlu membuka halaman ini <b style="color:var(--phantom)">di dalam browser Phantom</b>.</div>' +
      '<div class="ph-opts">' +
        '<a href="'+ul+'" class="ph-opt primary" style="flex-direction:column;gap:.3rem;padding:.9rem">' +
          '<span style="display:flex;align-items:center;gap:.5rem"><img src="'+logo+'" style="width:18px;height:18px;border-radius:4px"> Buka di Phantom App</span>' +
          '<span style="font-size:.46rem;opacity:.7;font-weight:400;letter-spacing:.05em">Recommended — halaman ini terbuka di Phantom browser</span>' +
        '</a>' +
        '<div class="ph-div">tidak berhasil?</div>' +
        '<a href="'+dl+'" class="ph-opt">Coba Deep Link</a>' +
      ...
      '</div>' +
      '<div class="ph-note">Setelah terbuka di Phantom, wallet langsung terconnect otomatis.</div>';
  } else {
