...
window.onerror = function(msg, src, line, col, err){
  ...
  if(t){
    ...
    el.style.cssText = 'background:#1a0000;border-left:3px solid #e74c3c;color:#e74c3c;font-family:monospace;font-size:11px;padding:.5rem .75rem;margin-bottom:.3rem;word-break:break-all;max-width:300px';
