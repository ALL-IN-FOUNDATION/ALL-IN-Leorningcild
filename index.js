...
function openPhModal(){
  ...
  if(ENV.mob){
    html = '<img src="'+logo+'" style="width:52px;height:52px;border-radius:14px;margin:0 auto .8rem;display:block" alt="Phantom">' +
      '<div class="mtext">Open this page inside the <b style="color:var(--phantom)">Phantom App browser</b> to connect.</div>' +
      '<div class="ph-opts">' +
        '<a href="'+dl+'" class="ph-opt primary" onclick="closePhModal();addLog(\\'Opening Phantom...\\',\\'inf\\')"><img src="'+logo+'"> Open in Phantom App</a>' +
        '<div class="ph-div">alternative</div>' +
        '<a href="'+ul+'" class="ph-opt" onclick="closePhModal()">Universal Link</a>' +
        '<div class="ph-div">no Phantom yet?</div>' +
      ...
      '</div>' +
      '<div class="ph-note">After opening in Phantom, reconnects automatically.</div>';
  } else {
    html = '<img src="'+logo+'" style="width:52px;height:52px;border-radius:14px;margin:0 auto .8rem;display:block" alt="Phantom">' +
