...
/* grain overlay — z-index REMOVED, pindah ke -1 agar tidak block touch */
body::before{content:'';position:fixed;inset:0;pointer-events:none;touch-action:none;z-index:-1;
...
body::after{content:'';position:fixed;top:-120px;left:-80px;width:420px;height:420px;
  ...
  pointer-events:none;touch-action:none;z-index:-1}
...
.lock{position:absolute;inset:0;z-index:4;background:rgba(1,3,10,.65);
