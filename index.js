...
function walletClick(){
  ...
  // Re-detect provider setiap kali — penting di mobile (Phantom inject setelah load)
  var prov = getProvider();
  if(prov){
    // Provider tersedia — langsung connect, tidak perlu modal
    doConnect();
    return;
  }

  // Cek apakah kita sudah di dalam Phantom in-app browser
  // Phantom in-app browser: window.solana ada tapi mungkin belum isPhantom
  if(window.solana && typeof window.solana.connect === 'function'){
    doConnect();
    return;
  }

  // Tidak ada provider — buka modal pilihan
  openPhModal();
}
...
function openPhModal(){
  ...
  // Link download sesuai device
  var storeLink = ENV.ios
    ? 'https://apps.apple.com/app/phantom-solana-wallet/id1598432977'
    : ENV.andr
      ? 'https://play.google.com/store/apps/details?id=app.phantom'
      : 'https://phantom.app/download';
  var storeLabel = ENV.ios
  ...
  var html =
    ...
    '<div class="ph-opts">' +
      ...
      // ── OPSI 1: Phantom Mobile (in-app browser) ──
      ...
      // ── OPSI 2: Ekstensi Browser Chrome ──
